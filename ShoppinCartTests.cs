...
namespace HPlusSportTDD.Core.Tests
{
    class ShoppinCartTests
    {
        ...
        [Test]
        public void ShoudlReturnArticleAddedtoCart()
        {
        ...
        [Test]
        public void ShoudlReturnArticlesAddedtoCart()
        {
        ...
        [Test]
        public void ShoudlReturnCorrectSumOfArticle()
        {
            var item1 = new AddToCartItem()
            {
                ArticleId = 42,
